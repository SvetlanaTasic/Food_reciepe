...
export default function Details() {
    ...
    return <div className="containter mx-auto py-10 grid grid-cols-1 lg:grid-cols-2 gap-10">
        <div className="row-start-2nlg:row-start-auto">
        ...
        <div className="flex flex-col gap-3">
            ...
            <div>
                <button onClick={() => handleAddToFavorite(recipeDetailsData?.recipe)} className="p-3 px-8 rounded-lg text-sm uppercase font-medium tracking-wider nt-3 inline-block shadow-md bg-black text-white ">
